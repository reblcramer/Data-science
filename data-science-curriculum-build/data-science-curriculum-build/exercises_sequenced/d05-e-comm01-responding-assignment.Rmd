...
- Is the bolded response **active** or **passive**? active, its enthusiastic and answers the question 
- Is the bolded response **constructive** or **destructive**? constructive, instead of pointing blame at the question asker for not assuming what isn't there it compliments the asker for pointing out that the axes arent labled
...
- Is the bolded response **active** or **passive**? Why? passive, seems less enthusiastic and moves on without ever actually answering the question
- Is the bolded response **constructive** or **destructive**? Why? somewhat constructive doesnt put down collegue but ignores question
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
q1 prompt would definitely make me feel more like my question was valued than q2
