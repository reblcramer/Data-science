...
**Observations**:
- there are the highest number of ideal cut diamonds so your hypothesis was not correct 
...
I cant tell from this graph if ideal cut diamonds cost the most, the graph doesnt include other factors or show clearly how many diamonds cost each amount 
...
**Observations**:
- Write your observations here!
this graph is much more useful but contradicts hypothesis 2 as ideal cut diamonds are typically less expensive than others
...
**Observations**:
- yes this plot supports the idea that cutters sacrifice carat for better cuts of diamond
