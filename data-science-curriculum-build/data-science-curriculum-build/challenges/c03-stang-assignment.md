...
- How many aluminum alloys are in this dataset? How do you know?
  - There is one aluminum alloy in this dataset. I know because the
    N.unique for alloys is 1.
...
- Does this graph support or contradict the claim above?
  - The E values are generally lower for thicker samples and higher for
    thinner samples which would contradict the claim.
- Is this evidence *conclusive* one way or another?
  - While the graph has a clear cluster of the thickest plates, the
    other points are not as clearly clustered. There are also not enough
    data points for this to be conclusive with so much overlap between
    each thickness.
