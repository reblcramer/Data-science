...
**Observations**:
shows all combinations of groupings of variables
...
Age
Survived
n: number people in each combination of groups
...
- Are there any differences?
  - (Your response here)
  the count of passengers on wikipedia is 2208, 7 higher than the count in this dataset
- If yes, what might account for those differences?
  -  People who cancelled trips last minute were wrongfully included on the ships passenger list, and 
  passengers who traveled under aliases may have been double counted.
  - ...
...
supposedly all first class passengers survived which according to the table is not true
...
It seems to plot overlapping values on top of eachother which caused the error in the previous graph. This graph correctly shows that only first and second class children had a 100% survival rate
